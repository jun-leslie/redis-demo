...
import com.roy.redisdemo.config.TencentSMSConfig;
...
public class SMSUtils {
     ...
     * 发送腾讯云短信
     */
    public boolean sendTencentSMS(String phone,String code,String time){
        ...
        try {
            ...
            String sign = tencentSMSConfig.getSign();
            req.setSign(sign);
            ...
            String templateID = tencentSMSConfig.getTemplateID();
            ...
            if(res.getSendStatusSet().length>0){
                ...
                return "Ok".equals(resCode)?true:false;
            }
